...
# append()              #adding a new element in the end
my_list.append(4)
print("List after appending:", my_list)

# extend()              #extending with the list(multiple)
my_list.extend([5, 6])
print("List after extending:", my_list)

# insert()              #rest of the items will be shifted from particular provided index value
my_list.insert(1, 'a')
...
print(my_list)
print(my_list.remove(4))    #removed the first occurance