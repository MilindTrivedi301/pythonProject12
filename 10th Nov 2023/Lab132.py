...
from abc import ABC, abstractmethod             #abc is module for abstracclass method
...
class Dog(Animal):          #creating a new dog class from animal class
    def sound(self):
        return "Bow Bow"


class Cat(Animal):          #creating a new cat class from animal class
    def sound(self):
        return "Meow"


class Tiger(Animal):        #creating a new tiger class from animal class
    def sound(self):
